...
export function createTutorServer() {
  const server = new MCPServer({
    ...
    instructions:
      "Call load_video before tutoring a new URL. For timestamp questions call set_position then get_context or ask_at_position. For concept confusion call find_concept. Always cite timestamps from tool results; never invent quotes.",
  });
  ...
  server.tool(
    {
      ...
      schema: z.object({
        ...
        halfWindowSec: z.number().optional(),
      }),
    },
